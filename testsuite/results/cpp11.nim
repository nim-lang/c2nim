...
proc `<<`*(`out`: var ostream; t: Enum): var ostream {.importcpp: "(# << #)",
    header: "cpp11.hpp".}
let foo* {.importcpp: "foo", header: "cpp11.hpp".}: Event

type
  ConstexprConstructor* {.importcpp: "ConstexprConstructor",
                          header: "cpp11.hpp", bycopy.} = object ## deprecated("getCenter() was renamed to getResourceDepot()")


proc constructConstexprConstructor*(i: cint = 1): ConstexprConstructor {.
    constructor, importcpp: "ConstexprConstructor(@)", header: "cpp11.hpp".}
##  list initialization, issue #163

let list_init* {.importcpp: "list_init", header: "cpp11.hpp".}: cint
...
proc pureFunction*(this: var VirtClass) {.importcpp: "pureFunction",
    header: "cpp11.hpp".}
proc implementedFunction*(this: var VirtClass) {.
    importcpp: "implementedFunction", header: "cpp11.hpp".}
proc concreteFunction*(this: var VirtClass) {.importcpp: "concreteFunction",
    header: "cpp11.hpp".}
let my_var* {.importcpp: "VarNS::my_var", header: "cpp11.hpp".}: cint
