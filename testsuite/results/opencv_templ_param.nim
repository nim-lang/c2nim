type
  ParamType_TvectorMat*[T: vector[Mat]] {.
      importcpp: "ParamType_TvectorMat<\'0>", header: "opencv_templ_param.hpp",
      bycopy.} = object
...
proc normRegular*(a: ptr Tp; b: ptr Tp; n: cint): _AccTp {.
    importcpp: "normRegular".}
