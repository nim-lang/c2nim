...
const
  ...
  c2nimExtrasCmd = dotslash & "c2nim --stdints --strict --header --reordercomments --def:RCL_PUBLIC='__attribute__ ()' --def:RCL_WARN_UNUSED='__attribute__ ()' --render:extranewlines $#"
  dir = "testsuite/"
  usage = """
c2nim test runner
